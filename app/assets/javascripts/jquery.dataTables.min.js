...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnDraw( oSettings, noAjax )
		{
      ...
      else if ( !oSettings.bDestroying && typeof(noAjax) == "undefined" && !_fnAjaxUpdate( oSettings ) )			  
			{
				return;
			}
			...
			else
			{
                            ...
                            anRows[ 0 ].appendChild( nTd );


                            anRows[ 1 ] = document.createElement( 'tr' );

                            if ( oSettings.asStripeClasses[0] )
                            {
                                    anRows[ 1 ].className = oSettings.asStripeClasses[1];
                            }
                            var nTd2 = document.createElement( 'td' );
                            nTd2.setAttribute( 'valign', "top" );
                            nTd2.colSpan = _fnVisbleColumns( oSettings );
                            nTd2.className = oSettings.oClasses.sRowEmpty;
                            nTd2.innerHTML = _fnInfoMacros( oSettings, sZero );

                            anRows[ 1 ].appendChild( nTd2 );

                            anRows[ 2 ] = document.createElement( 'tr' );

                            if ( oSettings.asStripeClasses[0] )
                            {
                                    anRows[ 2 ].className = oSettings.asStripeClasses[0];
                            }
                            var nTd3 = document.createElement( 'td' );
                            nTd3.setAttribute( 'valign', "top" );
                            nTd3.colSpan = _fnVisbleColumns( oSettings );
                            nTd3.className = oSettings.oClasses.sRowEmpty;
                            nTd3.innerHTML = ".";
                            nTd3.style.color = "white";

                            anRows[ 2 ].appendChild( nTd3 );
		...
		function _fnSort ( oSettings, bApplyClasses )
		{
			...
			for ( i=0, iLen=oSettings.aoColumns.length ; i<iLen ; i++ )
			{
                ...
                var thData = jQuery(nTh).find("span.thData");
                thData.removeClass("sorting_img_asc").removeClass("sorting_img_desc");
				...
				if ( aoColumns[i].bSortable )
				{
					if ( aaSort.length > 0 && aaSort[0][0] == i )
					{
					    ...
					    var sortClass = aaSort[0][1]=="asc" ? "sorting_img_asc" : "sorting_img_desc";
					    thData.addClass(sortClass);
